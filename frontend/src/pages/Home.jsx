...
const RenderCards = ({data, title})=>{  //if data was found 
    if(data.length>0){
...
const Home = () => {
  ...
  const [searchText, setsearchText] = useState('Shahrukh');
                ...
                <div className="grid lg:grid-cols-4 sm:grid-cols-3 xs:grid-cols-2 grid-cols-1 gap-3">
                    {
                      searchText ? (
                        <RenderCards
                          data={[]} //data being passed is handled by RenderCard function at the top
